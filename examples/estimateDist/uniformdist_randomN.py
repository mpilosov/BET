        ...
        for num_samples_param_space in num_sample_list:
            ...
            for trial in range(num_trials):
                ...
                for qoi_choice_idx in range(len(QoI_choice_list)):
                    ...
                    my_discretization = invert_using(My_Discretization, Partition_Discretization, Emulated_Discretization, QoI_indices, Emulate = True)
                    
                    for num_hell_bins in num_hell_bins_list:
                        (bins, temp_marginal) = plotP.calculate_2D_marginal_probs(my_discretization, nbins = num_hell_bins)
